 ...
 * only  has one item to sell (because * @author Tenniel
 */
public class Store {
     ...
     */
    public Store(double input_price, Weapon input_stock, Hero customer){
        price = input_price;
        stock = input_stock;
        customer1 = customer;
    }
    ...
    public void storeMenu() throws IOException{
        ...
        while(true){
            ...
            if (decide.equals("y")){
             ...
             Weapon weapon1 = new Weapon(stock.getName(),1,price);
             //customer1.loseGold( price ); done in sell_Stock, do not do it here
             customer1.equipWeapon(weapon1);
